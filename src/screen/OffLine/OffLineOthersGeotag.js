...
const OffLineOthersGeotag = () => {
    ...
    useEffect(() => {
        SqlData.createTablex("SaveOthersGeotagTable");
    ...
    const handleSubmit = () => {
        if (isCurrentLatitude == -1 || isCurrentLongitude == -1) {
            ...
            SqlData.setDatax('SaveOthersGeotagTable', false, obj, (response) => {
...
export default memo(OffLineOthersGeotag);
