...
const OffLineCreateFeederGeoTag = (props) => {
    ...
    // Handle click
    const handleClick = () => {
        props.navigation.navigate("OffLineFeederGeneralAssetDetail", { parentData, selectedDistricts, geotagModule, geotagType, selectedDistrictsName, sessionType });
    };
            ...
            <ScrollView>
                <View style={styles.container}>
                    ...
                    <View style={styles.innerContainer}>
                        <InputFields3
                            title1={"Length of Feeder (CMtrs)"}
                            value1={"0"}
                            title2={"Physical Progress"}
                            value2={"0"}
                        />
                        ...
                        {/* <Text style={styles.assetsText}>
                            {isList.length + " geo-coordinates saved"}
                        </Text> */}
                    </View>
...
export default memo(OffLineCreateFeederGeoTag);
