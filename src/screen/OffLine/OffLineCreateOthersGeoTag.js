...
const OffLineCreateOthersGeoTag = (props) => {
    ...
    // Handle click
    const handleClick = () => {
        props.navigation.navigate("OffLineOthersGeotag", { parentData, selectedDistricts, geotagModule, geotagType, selectedDistrictsName, sessionType });
    };
...
const styles = StyleSheet.create({
    ...
    taggedByName2: { width: "60%", color: Colors.secondary, fontSize: 14, fontWeight: "bold", },
...
export default memo(OffLineCreateOthersGeoTag);
