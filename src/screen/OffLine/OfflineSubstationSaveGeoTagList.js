...
// create a component
const OffLineSubstationSaveGeoTagList = (props) => {
    ...
    function onSavePress(item) {
        props.navigation.navigate("OffLineSubstationsGeneralAssetScreen", { item });
    }
    ...
    return (
        <SafeAreaView style={{ flex: 1 }}>
            <Header
                ...
                title="Offline Substation Geotag List"
                leftIcon={<IcnBack />}
            />
...
export default memo(OffLineSubstationSaveGeoTagList);
