...
function SvgComponent(props) {
  return (
    ...
    >
      <Path
        d="M12 6.25a.75.75 0 01.75.75v5.19l1.72-1.72a.75.75 0 111.06 1.06l-3 3a.75.75 0 01-1.06 0l-3-3a.75.75 0 111.06-1.06l1.72 1.72V7a.75.75 0 01.75-.75zM7.25 17a.75.75 0 01.75-.75h8a.75.75 0 010 1.5H8a.75.75 0 01-.75-.75z"
        fill="#fff"
      />
      <Path
        fillRule="evenodd"
