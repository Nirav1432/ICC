...
import { CircuitType1, Scheme1, SinglePhaseThreePhase1, TypeOfCable1, TypeOfCableSize1, TypeOfCableSize2, TypeOfCableSize3, TypeOfCableSize4, TypeOfConductor1, UGorOH1, WhetherCableOrConductor1 } from "../utils/CardData";
import SingleValueDropdownListSetOldData from "./singleselectlist/SingleValueDropdownListSetOldData";


// create a component
const LTLineOfflinePopup = ({ handleClose, isModalVisible,
                ...
                <View style={ModalViewStyle.container}>
                    <KeyboardAwareScrollView>
                        ...
                        <View style={ModalViewStyle.fields}>
                            ...
                            <SingleValueDropdownListSetOldData oldIndex={SinglePhaseThreePhase1?.indexOf(oldSinglePhaseThreePhase)} title={"Single Phase / Three Phase*"} data={SinglePhaseThreePhase1} 
                            onSelectedSevice={(value) => {setSinglePhaseThreePhase(value),onSelectSinglePhaseThreePhase(value)}} />
                            ...
                            {/* {
                                isTypeCableConductor == "Cable" &&
                                <View style={ModalViewStyle.marginTop} >
                                    <Text style={ModalViewStyle.headerText}>{"Cable Size*"}</Text>
                                    <TextInput
                                        maxLength={70}
                                        value={isCableSize}
                                        style={ModalViewStyle.inpView}
                                        // keyboardType="numeric"
                                        onChangeText={(txt) => { setCableSize(txt), onSelectCableSize(txt) }}
                                    />
                                </View>
                            } */}
...
export default React.memo(LTLineOfflinePopup);
