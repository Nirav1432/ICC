...
import { Scheme1, UGorOH1, LTLineVoltage1, WhetherCableOrConductor1, TypeOfCable1, TypeOfConductor1, PoleStructur1, CircuitType1, TypeOfCableSize2, TypeOfCableSize4 } from "../utils/CardData";
import SingleValueDropdownListSetOldData from "./singleselectlist/SingleValueDropdownListSetOldData";

// create a component
const HTLineOfflinePopup = ({ handleClose, isModalVisible,
                ...
                <View style={ModalViewStyle.container}>
                    <KeyboardAwareScrollView>
                        ...
                        <View style={ModalViewStyle.fields}>
                            ...
                            {isHTLineVoltage == "Other" && <View style={ModalViewStyle.marginTop} >
                            ...
                            {isTypeCableConductor == "Cable" && isTypeOfCable == "Other" && <View style={ModalViewStyle.marginTop} >
...
export default React.memo(HTLineOfflinePopup);
