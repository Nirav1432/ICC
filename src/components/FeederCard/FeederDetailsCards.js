...
export default function FeederDetailsCards({ title, index_id, created_by_date, created_by_time, address, latitude, longitude, tag_by, images, onPressImage, midalPath, innerbutton, deletIconPress, editIconPress, type, moreDetails, onDetails, othersAssetType }) {
    ...
    return (
        <>
            <View style={CommonStyle.card}>
                    ...
                    <View style={CommonStyle.cardRight}>
                        ...
                        <View style={CommonStyle.cardRightTop}>
                            <Text style={CommonStyle.rightDate}>
                                ...
                                <Text>
                                    {" "}
                                    {created_by_date && moment(created_by_date.toString()).format("DD/MM/YYYY")}
                                </Text>
                            </Text>
                            <Text style={CommonStyle.rightTime}>
                                ...
                                <Text>
                                    {" "}
                                    {created_by_time && moment(created_by_time.toString()).format("hh:mm a")}
                                </Text>
                            </Text>
                        </View>
                ...
                {moreDetails &&
                    <TouchableOpacity style={CommonStyle.buttonView6} onPress={() => onDetails()}>
