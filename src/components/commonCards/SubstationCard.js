...
const SubstationCard = ({ title, index_id, created_by_date, created_by_time, address, latitude, longitude, tag_by, images, imagePressed, editIconPress, deletIconPress, status, onCardPress, type, typeClick, othersAssetType }) => {
...
export default memo(SubstationCard);
