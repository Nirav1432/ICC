...
const MultiDropdownList = (props) => {
    ...
    return (
        ...
        <View style={PageStyle.mainView1}>
                    ...
                    renderCustomizedButtonChild={(selectedItem, index) => {
                        return (
                            <View style={PageStyle.dropdown3BtnChildStyle}>
                                <Text style={PageStyle.txtCaption}>{selectedItem ? selectedItem.title : 'Select'}</Text>
                                <IcnGreyDown />
                            </View>
                        );
                    }}
                    ...
                    renderCustomizedRowChild={(item, index) => {
                        return (
                            <View style={PageStyle.dropdown3RowChildStyle}>
                                <Text style={PageStyle.dropdown3RowTxt}>{item.title}</Text>
                            </View>
                        );
                    }}
                />
...
export default React.memo(MultiDropdownList);