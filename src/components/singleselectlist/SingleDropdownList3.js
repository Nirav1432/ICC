...
const SingleDropdownList3 = (props) => {
                    ...
                    renderCustomizedButtonChild={(selectedItem, index) => {
                        return (
                            <View style={PageStyle.dropdown3BtnChildStyle}>
                                <Text style={PageStyle.txtCaption}>{selectedItem?.name != null ? (selectedItem?.name + " - " + selectedItem?.code) : 'Select'}</Text>
                                <IcnGreyDown />
                            </View>
                        );
                    }}
                    ...
                    renderCustomizedRowChild={(item, index) => {
                        return (
                            <View style={PageStyle.dropdown3RowChildStyle}>
                                <Text style={PageStyle.dropdown3RowTxt}>{item?.name + " - " + item?.code}</Text>
                            </View>
                        );
                    }}
                />
...
export default React.memo(SingleDropdownList3);