...
import { ApprovalFilterStyle } from "../../components/approval/ApprovalFilterStyle";
...
export default function HistoryFilter({ handleClose, modalVisible, oldFilter, newFilter, data, feederName }) {
