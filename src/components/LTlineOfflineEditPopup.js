...
import { CircuitType1, Scheme1, SinglePhaseThreePhase1, TypeOfCable1, TypeOfConductor1, UGorOH1, WhetherCableOrConductor1 } from "../utils/CardData";
                    ...
                    <KeyboardAwareScrollView>
                        ...
                        <View style={ModalViewStyle.fields}>
                            ...
                            }
                            {
                                oldSinglePhaseThreePhase &&
                                <View style={{ marginTop: 10 }}>
                                    <DisableView title={"Single Phase / Three Phase"} value={oldSinglePhaseThreePhase} />
                                </View>
                            }
                            {
                                oldCableSize &&
