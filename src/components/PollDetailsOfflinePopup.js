...
// create a component
const PollDetailsOfflinePopup = ({ handleClose, isModalVisible, option,
                ...
                <View style={ModalViewStyle.container}>
                    <KeyboardAwareScrollView>
                        ...
                        <View style={ModalViewStyle.fields}>
                            ...
                            {
                                isPoleType === "Others" && <View style={ModalViewStyle.marginTop} >
...
export default PollDetailsOfflinePopup;
