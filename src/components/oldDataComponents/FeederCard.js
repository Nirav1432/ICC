...
const FeederCard = ({ title, index_id, created_by_date, created_by_time, address, latitude, longitude, tag_by, images, editIconPress, deletIconPress, status, onPressImage }) => {
...
export default memo(FeederCard);
